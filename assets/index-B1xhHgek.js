...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function lc(){return new Qt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Uo(),fragmentShader:`
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function cc(){return new Qt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Uo(),fragmentShader:`
...
`].filter(ns).join(`
`)),a=yo(a),a=vc(a,t),a=xc(a,t),o=yo(o),o=vc(o,t),o=xc(o,t),a=yc(a),o=yc(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(v=`#version 300 es
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
		...
		}`};class Mv extends ws{constructor(){super();const e=yv;this.uniforms=$s.clone(e.uniforms),this.material=new D_({name:e.name,uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader}),this.fsQuad=new Yo(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},et.getTransfer(this._outputColorSpace)===ht&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===_h?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===vh?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===xh?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===Lo?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===yh&&(this.material.defines.AGX_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}const it=4,xs=3.6,bi=.32,rn=8,_t=it*rn,To=1.62,Sv=1.8,Tv=.34,Ev=3.5,$c=6,as=100,bv=22,Av=14,wv=4.6,Rv=13.5,Cv=1.9,Lv=12,yu=10,Pv=300,Mu=8,Su=30,Tu=2.5,Qa=18,Eu=4,bu=20,Au=2.5,Iv=10,Zc={low:{chunkRadius:1,lights:5,shadowLights:0,shadowMap:512,bloom:!0,pixelRatio:.85,fogDensity:.075},medium:{chunkRadius:2,lights:8,shadowLights:2,shadowMap:768,bloom:!0,pixelRatio:1,fogDensity:.055},high:{chunkRadius:2,lights:12,shadowLights:3,shadowMap:1024,bloom:!0,pixelRatio:1.5,fogDensity:.05}},Dv={uniforms:{tDiffuse:{value:null},time:{value:0},grain:{value:.085},vignette:{value:1.05},fear:{value:0},aberration:{value:.0014}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
